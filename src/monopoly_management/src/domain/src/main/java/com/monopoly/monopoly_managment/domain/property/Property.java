...
public void assignOwner(String ownerId, String propertyId){
    apply(new OwnerAssigned(ownerId, propertyId));
}

public void removeOwner(String ownerId, String propertyId){
    apply(new OwnerRemoved(ownerId, propertyId));
}

public void modifyOwner(String ownerId, String propertyId, String previousOwnerId){
